...
class Offre(Base):
    ...
    frais_sim: Mapped[float | None] = mapped_column(Float, nullable=True)
    frais_resiliation: Mapped[float | None] = mapped_column(Float, nullable=True)
    frais_portabilite: Mapped[float | None] = mapped_column(Float, nullable=True)
