...
// Utilisées par les fiches prospect/client (ProspectForm.tsx/ClientForm.tsx,
// champs "réseau actuel" éditables hors diagnostic) — plus par le diagnostic
// lui-même, dont la situation Télécom passe désormais par la trame IA Conseil
// (voir components/diagnostic/EtapeTrame.tsx).
